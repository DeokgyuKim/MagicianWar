...
//
//
PxRigidStatic* CPhysXMgr::CreateTriangleStaticMesh(string meshname, XMMATRIX matWorld)
{
...
//}
//
PxCapsuleController* CPhysXMgr::CreateCapsuleController(DWORD dwPlayerNum, XMFLOAT3 Pos_, float Radius, float Height, bool Player)
{
