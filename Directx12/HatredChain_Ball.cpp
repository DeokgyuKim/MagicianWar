...
#include "Renderer.h"
HatredChain_Ball::HatredChain_Ball(ID3D12Device* device, ID3D12GraphicsCommandList* cmdLst, Renderer* pRenderer, XMFLOAT3 pos, Object* pParent)
...
HatredChain_Ball::~HatredChain_Ball()
{
}

void HatredChain_Ball::BuildComponent()
{
...
void HatredChain_Ball::AddTexturesName()
{
...
void HatredChain_Ball::BuildShaders()
{
...
void HatredChain_Ball::LateUpdate(const float& fTimeDelta)
{
...
void HatredChain_Ball::Render(const float& fTimeDelta, int _instanceCount)
{
