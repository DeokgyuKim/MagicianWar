...
SkyboxCube::SkyboxCube(ID3D12Device* device, ID3D12GraphicsCommandList* cmdLst, ID3D12DescriptorHeap* heap)
...
HRESULT SkyboxCube::BuildGeometry(ID3D12Device* device)
{
	std::array<SkyboxVertex, 8> vertices =
	{
		SkyboxVertex({ XMFLOAT3(-1.0f, -1.0f, -1.0f), XMFLOAT3(0.f, 1.f, 0.f), XMFLOAT3(-1.0f, -1.0f, -1.0f) }),
		SkyboxVertex({ XMFLOAT3(-1.0f, +1.0f, -1.0f), XMFLOAT3(0.f, 1.f, 0.f), XMFLOAT3(-1.0f, +1.0f, -1.0f) }),
		SkyboxVertex({ XMFLOAT3(+1.0f, +1.0f, -1.0f), XMFLOAT3(0.f, 1.f, 0.f), XMFLOAT3(+1.0f, +1.0f, -1.0f) }),
		SkyboxVertex({ XMFLOAT3(+1.0f, -1.0f, -1.0f), XMFLOAT3(0.f, 1.f, 0.f), XMFLOAT3(+1.0f, -1.0f, -1.0f) }),
		SkyboxVertex({ XMFLOAT3(-1.0f, -1.0f, +1.0f), XMFLOAT3(0.f, 1.f, 0.f), XMFLOAT3(-1.0f, -1.0f, +1.0f) }),
	...
	m_BoxGeo->VertexByteStride = sizeof(SkyboxVertex);
