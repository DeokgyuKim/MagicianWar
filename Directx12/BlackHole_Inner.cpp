...
#include "Renderer.h"
BlackHole_Inner::BlackHole_Inner(ID3D12Device* device, ID3D12GraphicsCommandList* cmdLst, Renderer* pRenderer, Object* pParent)
...
BlackHole_Inner::~BlackHole_Inner()
{
}

void BlackHole_Inner::BuildComponent()
{
	Component* pComponent = new Transform(XMFLOAT3(0.0061f, 0.0061f, 0.0061f), XMFLOAT3(90.f, 0.f, 0.f), XMFLOAT3(0.f, 0.01f, 0.f));
...
void BlackHole_Inner::AddTexturesName()
{
...
void BlackHole_Inner::BuildShaders()
{
...
void BlackHole_Inner::LateUpdate(const float& fTimeDelta)
{
...
void BlackHole_Inner::Render(const float& fTimeDelta, int _instanceCount)
{
