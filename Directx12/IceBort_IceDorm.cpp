...
IceBort_IceDorm::IceBort_IceDorm(ID3D12Device* device, ID3D12GraphicsCommandList* cmdLst, Renderer* pRenderer, Object* pParent)
...
IceBort_IceDorm::~IceBort_IceDorm()
{
}

void IceBort_IceDorm::BuildComponent()
{
...
void IceBort_IceDorm::AddTexturesName()
{
...
void IceBort_IceDorm::BuildShaders()
{
...
void IceBort_IceDorm::ReBuildShaders()
{
...
void IceBort_IceDorm::LateUpdate(const float& fTimeDelta)
{
...
void IceBort_IceDorm::Render(const float& fTimeDelta, int _instanceCount)
{
