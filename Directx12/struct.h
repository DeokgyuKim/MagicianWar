...
enum class ANIMATION_TYPE : int { IDLE = 0, WALK_FOWARD, WALK_BACK, WALK_LEFT, WALK_RIGHT, ATTACK, JUMP, HIT, DEAD, DANCE, SKILLATTACK, NONE };
...
enum SKILL_TYPE					{ SKILL_FIRE1 = 2, SKILL_FIRE2, SKILL_COLD1, SKILL_COLD2, SKILL_DARKNESS1, SKILL_DARKNESS2, SKILL_CRESSVAS };
enum BUTTON_TAG					
{ 
	BUTTON_ROOM_MAKE, 
	WIZARD_FIRE,
