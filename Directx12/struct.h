...
enum RENDER_TYPE				{ RENDER_NOBLEND, RENDER_STATIC, RENDER_DYNAMIC, RENDER_SHADE, RENDER_BLEND, RENDER_SKYBOX, RENDER_BULLET, RENDER_SKILL, RENDER_UI, RENDER_UI_ROOMS, RENDER_END };
