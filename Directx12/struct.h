...
enum RENDER_TYPE				{ RENDER_NOBLEND, RENDER_STATIC, RENDER_DYNAMIC, RENDER_SHADE, RENDER_BLEND, RENDER_SKYBOX, RENDER_BULLET, RENDER_SKILL, RENDER_UI, RENDER_UI_ROOMS, RENDER_UI_TEXT, RENDER_END };
...
enum BUTTON_TAG					{ BUTTON_ROOM_MAKE, BUTTON_ROOM_JOIN, BUTTON_GAME_READY, BUTTON_GAME_START, BUTTON_ROOM_EXIT, BUTTON_ROOM_END };
