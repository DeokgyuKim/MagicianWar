...
enum class ANIMATION_TYPE : int { IDLE = 0, WALK_FOWARD, WALK_BACK, WALK_LEFT, WALK_RIGHT, ATTACK, JUMP, HIT, NONE };
enum class PLAYER_STATE : int	{ IDLE = 0, MOVE, ATTACK, JUMP, HIT, NONE };
